...
(defn bounding-box [inputs ](let [maxx (->> (map first inputs)
                                            (apply max))
                                  minx (->> (map second inputs)
                                            (apply min))
                                  maxy (->> (map first inputs)
                                            (apply max))
...
;; (findboxes inputs 1000 24000 1)
;; that generates the message
;; (day10/plot (day10/transform day10/inputs 10086))~
